...
model.add(keras.layers.Dense(units=96, input_dim=n, activation='relu'))
model.add(keras.layers.BatchNormalization())
model.add(keras.layers.Dense(units=48, input_dim=n, activation='relu'))
model.add(keras.layers.BatchNormalization())
model.add(keras.layers.AlphaDropout(0.7))
...
model.save("model_deep_mlp.h5")
print("Saved model to disk")

# Testing model
# Load model
model = keras.models.load_model('model_deep_mlp.h5')
# Summarize model.
model.summary()
# Evaluate the model
